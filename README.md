...
7. Now navigate back out of the database folder and into the pages folder and click on **register.php** (or just click or link that should appear).
...
- We can talk about wether we want to use Github to combine and keep track of changes and all that.